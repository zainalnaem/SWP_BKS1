...
public class bearbeitungsAdminGenehmigenController implements Initializable {
    ...
    private void bestaetigenBearbeitungsAdminCloseWindow_Button_On(ActionEvent event) {
        ...
        if (selectedAdmin != null) {
            ...
            antragGrenz.setAtid(antragID);
            antragGrenz.setTyp("ks");
            antragGrenz.setAdmin(selectedAdmin);
            boolean antragAccepted = iAntragManagerSteuerung.setAntragGenehmigt(antragGrenz);
            ...
            if (antragAccepted){
                ...
                alert.setHeaderText("Antrag genehmigt");
                alert.setContentText("Der Antrag wurde erfolgreich genehmigt");
                alert.showAndWait();
                ...
                alert.setHeaderText("Fehler beim Genehmigen des Antrags");
                alert.setContentText("Es ist ein Fehler beim Genehmigen des Antrags aufgetreten.");
                alert.showAndWait();
            }
        }
        else {
